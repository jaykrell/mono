...
#if _MSC_VER
	mono_register_jit_icall_info_full (&mono_chkstk_win64_jit_icall_info, __chkstk, "mono_chkstk_win64", NULL, TRUE, "__chkstk");
#else
	mono_register_jit_icall_info_full (&mono_chkstk_win64_jit_icall_info, ___chkstk_ms, "mono_chkstk_win64", NULL, TRUE, "___chkstk_ms");
#endif
#endif
}
