 ...
 */
	...
	mono_register_jit_icall_info (&mono_llvm_throw_exception_trampoline_icall_info, tramp, "llvm_throw_exception_trampoline", NULL, TRUE);
	...
	mono_register_jit_icall_info (&mono_llvm_rethrow_exception_trampoline_icall_info, tramp, "llvm_rethrow_exception_trampoline", NULL, TRUE);
	mono_tramp_info_register (tinfo, NULL);

	tramp = get_throw_trampoline ("llvm_throw_corlib_exception_trampoline", FALSE, TRUE, TRUE, FALSE, FALSE, &tinfo, FALSE, FALSE);
	mono_register_jit_icall_info (&mono_llvm_throw_corlib_exception_trampoline_icall_info, tramp, "llvm_throw_corlib_exception_trampoline", NULL, TRUE);
	mono_tramp_info_register (tinfo, NULL);

	tramp = get_throw_trampoline ("llvm_throw_corlib_exception_abs_trampoline", FALSE, TRUE, TRUE, TRUE, FALSE, &tinfo, FALSE, FALSE);
	mono_register_jit_icall_info (&mono_llvm_throw_corlib_exception_abs_trampoline_icall_info, tramp, "llvm_throw_corlib_exception_abs_trampoline", NULL, TRUE);
	mono_tramp_info_register (tinfo, NULL);

	tramp = get_throw_trampoline ("llvm_resume_unwind_trampoline", FALSE, FALSE, FALSE, FALSE, TRUE, &tinfo, FALSE, FALSE);
	mono_register_jit_icall_info (&mono_llvm_resume_unwind_trampoline_icall_info, tramp, "llvm_resume_unwind_trampoline", NULL, TRUE);
	mono_tramp_info_register (tinfo, NULL);
