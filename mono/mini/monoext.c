...
static const MonoExtFunction MonoExtFunctions[] = {
    // opt                          name                    return_type     param_count	param_types                     opcode                      stack_type
    // TODO There are no current IL-based or C-based fallbacks break/rdtsc so they justify different enablement.
    { 0,                            "DebugBreak",           MONO_TYPE_VOID, 0,          { MONO_TYPE_END },              OP_BREAK,                   STACK_VTYPE,   },
    { 0,                            "ReadTimeStampCounter", MONO_TYPE_U8,   0,          { MONO_TYPE_END },              OP_READ_TIME_STAMP_COUNTER, STACK_I8,      },
#ifdef MONO_ARCH_ROTATE_INTRINSICS
    // second parameter for rotate is I4 to be like shift
    { MONO_OPT_ROTATE_INTRINSICS,   "RotateLeft",           MONO_TYPE_U4,   2,          { MONO_TYPE_U4, MONO_TYPE_I4 }, OP_IROL,                    STACK_I4,      },
    { MONO_OPT_ROTATE_INTRINSICS,   "RotateRight",          MONO_TYPE_U4,   2,          { MONO_TYPE_U4, MONO_TYPE_I4 }, OP_IROR,                    STACK_I4,      },
    { MONO_OPT_ROTATE_INTRINSICS,   "RotateLeft",           MONO_TYPE_U8,   2,          { MONO_TYPE_U8, MONO_TYPE_I4 }, OP_LROL,                    STACK_I8,      },
    { MONO_OPT_ROTATE_INTRINSICS,   "RotateRight",          MONO_TYPE_U8,   2,          { MONO_TYPE_U8, MONO_TYPE_I4 }, OP_LROR,                    STACK_I8,      },
#endif
};
