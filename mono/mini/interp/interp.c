...
#if HOST_WASM
#define INTERP_SPLIT_RECURSE 1 /* 1 needed for iOS 13, 0 works everywhere */
#else
#define INTERP_SPLIT_RECURSE 1 /* 1 for testing, 0 for benchmarks */
#endif

static void interp_exec_method_full (InterpFrame *frame, ThreadContext *context, FrameClauseArgs *clause_args, MonoError *error);

#if INTERP_SPLIT_RECURSE
