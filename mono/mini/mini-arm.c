...
mono_arch_register_lowlevel_calls (void)
{
	...
	mono_register_jit_icall (mono_arm_throw_exception, mono_create_icall_signature ("void"), TRUE);
	mono_register_jit_icall (mono_arm_throw_exception_by_token, mono_create_icall_signature ("void"), TRUE);
	mono_register_jit_icall (mono_arm_unaligned_stack, mono_create_icall_signature ("void"), TRUE);
}
