...
typedef struct _MonoAppDomain MONO_RT_MANAGED_ATTR MonoAppDomain;
typedef struct  MonoAppDomainSetup MONO_RT_MANAGED_ATTR MonoAppDomainSetup;
typedef struct _MonoArray MONO_RT_MANAGED_ATTR MonoArray;
typedef struct  MonoComObject MONO_RT_MANAGED_ATTR MonoComObject;
typedef struct  MonoComInteropProxy MONO_RT_MANAGED_ATTR MonoComInteropProxy;
...
typedef struct  MonoManifestResourceInfo MONO_RT_MANAGED_ATTR MonoManifestResourceInfo;
typedef struct _MonoMulticastDelegate MONO_RT_MANAGED_ATTR MonoMulticastDelegate;
typedef struct _MonoReflectionAssembly MONO_RT_MANAGED_ATTR MonoReflectionAssembly;
typedef struct  MonoReflectionAssemblyBuilder MONO_RT_MANAGED_ATTR MonoReflectionAssemblyBuilder;
typedef struct  MonoReflectionDynamicMethod MONO_RT_MANAGED_ATTR MonoReflectionDynamicMethod;
...
typedef struct  MonoReflectionMarshalAsAttribute MONO_RT_MANAGED_ATTR MonoReflectionMarshalAsAttribute;
...
typedef struct  MonoReflectionSigHelper MONO_RT_MANAGED_ATTR MonoReflectionSigHelper;
...
typedef struct  MonoW32ProcessStartInfo MONO_RT_MANAGED_ATTR MonoW32ProcessStartInfo;
