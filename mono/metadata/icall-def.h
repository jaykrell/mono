...
HANDLES(CALDATA_1, "fill_calendar_data_icall", ves_icall_System_Globalization_CalendarData_fill_calendar_data, MonoBoolean, 4, (MonoCalendarData, const_gunichar2_ptr, int, gint32))
...
HANDLES(CULDATA_2, "fill_number_data", ves_icall_System_Globalization_CultureData_fill_number_data, void, 2, (MonoNumberFormatInfo, gint32))

ICALL_TYPE(CULINF, "System.Globalization.CultureInfo", CULINF_5)
HANDLES(CULINF_5, "construct_internal_locale_from_lcid", ves_icall_System_Globalization_CultureInfo_construct_internal_locale_from_lcid, MonoBoolean, 2, (MonoCultureInfo, gint))
...
HANDLES(REGINF_2, "construct_internal_region_from_name_icall", ves_icall_System_Globalization_RegionInfo_construct_internal_region_from_name,
	MonoBoolean, 3, (MonoRegionInfo, const_gunichar2_ptr, int))
