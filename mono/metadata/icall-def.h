...
NOHANDLES(ICALL(TRACEL_1, "WriteWindowsDebugString", ves_icall_System_Diagnostics_DefaultTraceListener_WriteWindowsDebugString))
...
HANDLES(ICALL(ENV_4, "GetLogicalDrivesInternal", ves_icall_System_Environment_GetLogicalDrives))
...
NOHANDLES(ICALL(ENV_9, "get_ExitCode", mono_environment_exitcode_set))
...
NOHANDLES(ICALL(ENV_14, "get_ProcessorCount", mono_cpu_count))
...
NOHANDLES(ICALL(GC_0, "GetCollectionCount", mono_gc_collection_count))
HANDLES(ICALL(GC_0a, "GetGeneration", ves_icall_System_GC_GetGeneration))
NOHANDLES(ICALL(GC_0b, "GetMaxGeneration", mono_gc_max_generation))
NOHANDLES(ICALL(GC_1, "GetTotalMemory", ves_icall_System_GC_GetTotalMemory))
NOHANDLES(ICALL(GC_2, "InternalCollect", mono_gc_collect))
HANDLES(ICALL(GC_3, "KeepAlive", ves_icall_System_GC_KeepAlive))
NOHANDLES(ICALL(GC_4a, "RecordPressure", mono_gc_add_memory_pressure))
...
HANDLES(ICALL(IODRIVEINFO_1, "GetDiskFreeSpaceInternal", ves_icall_System_IO_DriveInfo_GetDiskFreeSpace))
HANDLES(ICALL(IODRIVEINFO_2, "GetDriveFormat", ves_icall_System_IO_DriveInfo_GetDriveFormat))
NOHANDLES(ICALL(IODRIVEINFO_3, "GetDriveTypeInternal", ves_icall_System_IO_DriveInfo_GetDriveType))
#endif
...
NOHANDLES(ICALL(GCH_2, "FreeHandle", mono_gchandle_free))
