...
NO_FRAME(BUFFER_2, "_ByteLength", ves_icall_System_Buffer_ByteLengthInternal)
NO_FRAME(BUFFER_3, "_GetByte", ves_icall_System_Buffer_GetByteInternal)
NO_FRAME(BUFFER_4, "_SetByte", ves_icall_System_Buffer_SetByteInternal)
...
HANDLES(MUTEX_1, "CreateMutex_icall", ves_icall_System_Threading_Mutex_CreateMutex_internal, gpointer, 4, (MonoBoolean, const_gunichar2_ptr, gint32, MonoBoolean_ref))
HANDLES(MUTEX_2, "OpenMutex_icall", ves_icall_System_Threading_Mutex_OpenMutex_internal, gpointer, 4, (const_gunichar2_ptr, gint32, gint32, gint32_ref))
...
HANDLES(NATIVEC_2, "CreateEvent_icall", gpointer, 5, (MonoBoolean, MonoBoolean, const_gunichar2_ptr, gint32, gint32_ref))
HANDLES(NATIVEC_3, "OpenEvent_icall", ves_icall_System_Threading_Events_OpenEvent_internal, gpointer, 4, (const_gunichar2_ptr, gint32, gint32, gint32_ref))
...
NOHANDLES(ICALL(SEMA_1, "CreateSemaphore_icall", ves_icall_System_Threading_Semaphore_CreateSemaphore_internal))
NOHANDLES(ICALL(SEMA_2, "OpenSemaphore_icall", ves_icall_System_Threading_Semaphore_OpenSemaphore_internal))
...
NOHANDLES(ICALL(THREAD_7, "GetDomainID", ves_icall_System_Threading_Thread_GetDomainID))
...
NOHANDLES(ICALL(THREAD_22, "SleepInternal", ves_icall_System_Threading_Thread_Sleep_internal))
NOHANDLES(ICALL(THREAD_54, "SpinWait_nop", ves_icall_System_Threading_Thread_SpinWait_nop))
