...
HANDLES(MCMETH_4, "get_metadata_token", ves_icall_reflection_get_token2, guint32, 1, (MonoObject))

ICALL_TYPE(MEV, "System.Reflection.MonoEvent", MEV_1)
HANDLES(MEV_1, "get_metadata_token", ves_icall_reflection_get_token3, guint32, 1, (MonoObject))
...
HANDLES(MFIELD_8, "get_metadata_token", ves_icall_reflection_get_token4, guint32, 1, (MonoObject))
...
HANDLES(MMETH_3, "GetGenericMethodDefinition_impl", ves_icall_MonoMethod_GetGenericMethodDefinition2, MonoReflectionMethod, 1, (MonoReflectionMethod))
...
HANDLES(MMETH_6, "get_IsGenericMethod", ves_icall_MonoMethod_get_IsGenericMethod, gboolean, 1, (MonoReflectionMethod))
HANDLES(MMETH_7, "get_IsGenericMethodDefinition", ves_icall_MonoMethod_get_IsGenericMethodDefinition, gboolean, 1, (MonoReflectionMethod))
HANDLES(MMETH_8, "get_base_method", ves_icall_MonoMethod_get_base_method, MonoReflectionMethod, 2, (MonoReflectionMethod, gboolean))
HANDLES(MMETH_10, "get_core_clr_security_level", ves_icall_MonoMethod_get_core_clr_security_level2, int, 1, (MonoReflectionMethod))
HANDLES(MMETH_12, "get_metadata_token", ves_icall_reflection_get_token5, guint32, 1, (MonoObject))
...
HANDLES(MPARAMI_1, "GetMetadataToken", ves_icall_reflection_get_token6, guint32, 1, (MonoObject))
...
HANDLES(MPROP_1, "get_metadata_token", ves_icall_reflection_get_token7, guint32, 1, (MonoObject))
...
// FIXME gulong is incorrect. It should be gsize.
HANDLES(MARSHAL_51,"AllocCoTaskMemSize(uintptr)", ves_icall_System_Runtime_InteropServices_Marshal_AllocCoTaskMemSize, gpointer, 1, (gulong))
HANDLES(MARSHAL_3, "AllocHGlobal", ves_icall_System_Runtime_InteropServices_Marshal_AllocHGlobal, gpointer, 1, (gsize))
HANDLES(MARSHAL_50, "BufferToBSTR", ves_icall_System_Runtime_InteropServices_Marshal_BufferToBSTR, mono_bstr, 2, (const_gunichar2_ptr, int))
...
HANDLES(MARSHAL_5, "FreeBSTR", ves_icall_System_Runtime_InteropServices_Marshal_FreeBSTR, void, 1, (mono_bstr_const))
HANDLES(MARSHAL_6, "FreeCoTaskMem", ves_icall_System_Runtime_InteropServices_Marshal_FreeCoTaskMem, void, 1, (gpointer))
HANDLES(MARSHAL_7, "FreeHGlobal", ves_icall_System_Runtime_InteropServices_Marshal_FreeHGlobal, void, 1, (gpointer))
#ifndef DISABLE_COM
...
#ifndef DISABLE_COM
HANDLES(MARSHAL_22, "QueryInterfaceInternal", ves_icall_System_Runtime_InteropServices_Marshal_QueryInterfaceInternal, int, 3, (MonoIUnknown_ptr, gconstpointer, gpointer_ptr))
#endif
...
HANDLES(MARSHAL_29, "ReleaseInternal", ves_icall_System_Runtime_InteropServices_Marshal_ReleaseInternal, int, 1, (MonoIUnknown_ptr))
#endif
...
HANDLES(RFH_2, "SetValueInternal", ves_icall_MonoField_SetValueInternal2, void, 3, (MonoReflectionField, MonoObject, MonoObject))
...
HANDLES(RT_31, "GetCorrespondingInflatedMethod", ves_icall_RuntimeType_GetCorrespondingInflatedMethod2, MonoReflectionMethod, 2, (MonoReflectionType, MonoReflectionMethod))
...
// FIXME gboolean should be MonoBoolean
HANDLES(RT_19, "getFullName", ves_icall_System_RuntimeType_getFullName, MonoString, 3, (MonoReflectionType, gboolean, gboolean))
...
HANDLES(RTH_7, "GetMetadataToken", ves_icall_reflection_get_token8, guint32, 1, (MonoObject))
HANDLES(RTH_8, "GetModule", ves_icall_RuntimeTypeHandle_GetModule, MonoReflectionModule, 1, (MonoReflectionType))
// FIXME MonoBoolean
HANDLES(RTH_9, "HasInstantiation", ves_icall_RuntimeTypeHandle_HasInstantiation, gboolean, 1, (MonoReflectionType))
...
// FIXME MonoBoolean
HANDLES(RTH_13, "IsGenericTypeDefinition", ves_icall_RuntimeTypeHandle_IsGenericTypeDefinition, gboolean, 1, (MonoReflectionType))
...
HANDLES_MAYBE(ENABLE_POLICY_EVIDENCE, WINIMP_1, "CloseToken", ves_icall_System_Security_Principal_WindowsImpersonationContext_CloseToken, gboolean, 1, (gpointer))
...
HANDLES_MAYBE(ENABLE_POLICY_EVIDENCE, WINIMP_3, "RevertToSelf", ves_icall_System_Security_Principal_WindowsImpersonationContext_RevertToSelf, gboolean, 0, ())
HANDLES_MAYBE(ENABLE_POLICY_EVIDENCE, WINIMP_4, "SetCurrentToken", ves_icall_System_Security_Principal_WindowsImpersonationContext_SetCurrentToken, gboolean, 1, (gpointer))

ICALL_TYPE(WINPRIN, "System.Security.Principal.WindowsPrincipal", WINPRIN_1)
HANDLES_MAYBE(ENABLE_POLICY_EVIDENCE, WINPRIN_1, "IsMemberOfGroupId", ves_icall_System_Security_Principal_WindowsPrincipal_IsMemberOfGroupId, gboolean, 2, (gpointer, gpointer))
HANDLES_MAYBE(ENABLE_POLICY_EVIDENCE, WINPRIN_2, "IsMemberOfGroupName", ves_icall_System_Security_Principal_WindowsPrincipal_IsMemberOfGroupName, gboolean, 2, (gpointer, const_char_ptr))
...
//FIXME MonoBoolean
//FIXME HANDLES(NATIVEC_4, "ResetEvent_internal", ves_icall_System_Threading_Events_ResetEvent_internal, gboolean, 1, (gpointer))
NOHANDLES(ICALL(NATIVEC_4, "ResetEvent_internal",  ves_icall_System_Threading_Events_ResetEvent_internal))
//FIXME MonoBoolean
//HANDLES(NATIVEC_5, "SetEvent_internal", ves_icall_System_Threading_Events_SetEvent_internal, gboolean, 1, (gpointer))
...
//FIXME MonoBoolean
HANDLES(THREAD_12, "JoinInternal", ves_icall_System_Threading_Thread_Join_internal, gboolean, 2, (MonoThreadObject, int))
...
HANDLES(WEBIC_3, "GetUnmanagedResourcesPtr", ves_icall_get_resources_ptr, gboolean, 3, (MonoReflectionAssembly, gpointer_ref, gint32_ref))
