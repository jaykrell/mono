...
MONO_JIT_ICALL (g_free) \
	\
MONO_JIT_ICALL (init_method) \
MONO_JIT_ICALL (init_method_gshared_mrgctx) \
MONO_JIT_ICALL (init_method_gshared_this) \
MONO_JIT_ICALL (init_method_gshared_vtable) \
	\
...
MONO_JIT_ICALL (mini_llvmonly_throw_nullref_exception) \
	\
MONO_JIT_ICALL (mono_aot_init_gshared_method_mrgctx) \
MONO_JIT_ICALL (mono_aot_init_gshared_method_this) \
MONO_JIT_ICALL (mono_aot_init_gshared_method_vtable) \
MONO_JIT_ICALL (mono_aot_init_llvm_method) \
