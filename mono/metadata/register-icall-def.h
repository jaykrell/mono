...
MONO_REGISTER_JIT_ICALL (mono_rconv_i8)
MONO_REGISTER_JIT_ICALL (mono_rconv_ovf_i8)
MONO_REGISTER_JIT_ICALL (mono_rconv_ovf_u8)
MONO_REGISTER_JIT_ICALL (mono_rconv_u8)
...
MONO_REGISTER_JIT_ICALL (mono_type_from_handle)
...
// emulation icalls do not need to expose the info and are not uniquely named
