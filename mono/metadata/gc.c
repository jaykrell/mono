...
finalizer_thread (gpointer unused)
{
	...
	MonoStringHandle finalizer = mono_string_new_handle (mono_get_root_domain (), "Finalizer", &error);
	mono_error_assert_ok (&error);
	mono_thread_set_name_handle_internal (mono_thread_internal_current (), finalizer, FALSE, FALSE, &error);
	mono_error_assert_ok (&error);
