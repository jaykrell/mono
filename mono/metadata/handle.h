...
// FIXME This should be inline in the header.
// 1. object-internals.h is not usable here without more refactoring.
// 2. This function was not previously entirely header-only, because mono_array_get
//    was not in a header, so no loss of performance. But it could be better.
void
...
//FIXME should be inline
void
mono_gchandle_target_is_null_or_equal (uint32_t gchandle, MonoObjectHandle equal, gboolean *is_null, gboolean *is_equal);
