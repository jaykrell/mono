...
//FIXME
//mono_bool
//mono_monitor_try_enter_internal (MonoObject *obj, uint32_t ms);
...
//FIXME
//void
//mono_monitor_enter_v4_internal (MonoObject *obj, char *lock_taken);
...
void
mono_runtime_exec_managed_code_internal (MonoDomain *domain, MonoMainThreadFunc main_func, void* main_args);
...
void
mono_gchandle_free_internal (uint32_t gchandle);
...
MonoObject*
mono_do_runtime_invoke (MonoMethod *method, void *obj, void **params, MonoObject **exc, MonoError *error);

int
mono_do_exec_main_checked (MonoMethod *method, MonoArray *args, MonoError *error);

int
mono_do_try_exec_main (MonoMethod *method, MonoArray *args, MonoObject **exc);

void
mono_prepare_thread_to_exec_main (MonoDomain *domain, MonoMethod *method);
