...
{
	return (MonoMarshalType*)mono_property_bag_get (&klass->infrequent_data, PROP_MARSHAL_INFO);
}
...
{
	Uint32Property *prop = (Uint32Property*)mono_property_bag_get (&klass->infrequent_data, PROP_REF_INFO_HANDLE);
...
mono_class_set_ref_info_handle (MonoClass *klass, guint32 value)
{
	...
	prop->value = value;
	prop = (Uint32Property*)mono_property_bag_add (&klass->infrequent_data, prop);
	return prop->value;
}
...
{
	return (MonoClassPropertyInfo*)mono_property_bag_get (&klass->infrequent_data, PROP_PROPERTY_INFO);
}
...
{
	return (MonoClassEventInfo*)mono_property_bag_get (&klass->infrequent_data, PROP_EVENT_INFO);
}
...
{
	Uint32Property *prop = (Uint32Property*)mono_property_bag_get (&klass->infrequent_data, PROP_DECLSEC_FLAGS);
	return prop ? prop->value : 0;
}
...
{
	WeakBitmapData *prop = (WeakBitmapData*)mono_property_bag_get (&klass->infrequent_data, PROP_WEAK_BITMAP);
