...
// Export do not work if compiled separately.
...
{
	//MONO_ENTER_GC_UNSAFE; //FIXME
	method = mono_object_get_virtual_method_internal (obj_raw, method);
	//MONO_EXIT_GC_UNSAFE; //FIXME
	return method;
}
...
{
	//FIXME MONO_EXTERNAL_ONLY_GC_UNSAFE_VOID (mono_field_set_value_internal (obj, field, value));
	MONO_EXTERNAL_ONLY_VOID (mono_field_set_value_internal (obj, field, value));
}
...
mono_field_static_set_value (MonoVTable *vt, MonoClassField *field, void *value)
{
	...
	MONO_EXTERNAL_ONLY_VOID (mono_field_static_set_value_internal (vt, field, value));
}
 ...
 */
int
mono_runtime_set_main_args_internal (int argc, char* argv[])
{
	MONO_REQ_GC_NEUTRAL_MODE;
...
{
	MONO_EXTERNAL_ONLY (int, mono_runtime_set_main_args_internal (argc, argv));
}
 ...
 */
void
mono_runtime_exec_managed_code_internal (MonoDomain *domain,
...
void
mono_runtime_exec_managed_code (MonoDomain *domain, MonoMainThreadFunc main_func, void* main_args)
{
	MONO_EXTERNAL_ONLY_VOID (mono_runtime_exec_managed_code_internal (domain, main_func, main_args));
}
