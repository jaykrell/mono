...
#ifdef __cplusplus
extern "C++" { // For nesting within extern "C".

// FIXME generate via a macro for all enums that are flags
inline MonoThreadCreateFlags
operator|(MonoThreadCreateFlags a, MonoThreadCreateFlags b)
{
	return (MonoThreadCreateFlags)((int)a | (int)b);
}
