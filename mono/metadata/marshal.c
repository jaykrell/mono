...
mono_marshal_init (void)
{
	...
	if (!module_initialized) {
		...
		register_icall (mono_string_to_utf16_internal, "mono_string_to_utf16", "ptr obj", FALSE);
		...
		register_icall (mono_string_new_wrapper_internal, "mono_string_new_wrapper", "obj ptr", FALSE);
		...
		register_icall (mono_gc_wbarrier_generic_nostore_internal, "wb_generic", "void ptr", FALSE);
		register_icall (mono_gchandle_get_target_internal, "mono_gchandle_get_target", "object int32", TRUE);
